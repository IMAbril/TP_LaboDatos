...
def clasificador_3Atributos_Variables():        
...
# Probamos con distintos conjuntos de tres atributos y comparamos resultados
def clasificador_atributosVariables():
        X = data_L_A.drop('label', axis=1)  # Conservamos todas las columnas excepto 'label'
        Y = data_L_A['label']
        ...
        for cant_atributos in range(1, 6):  # Probamos con atributos desde 1 a 5
